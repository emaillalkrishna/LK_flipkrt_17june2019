...
def search_product():
    ...
    driver.find_element_by_xpath("//a[contains(., 'iphone')])[1]")
    ...
    # # # Click on any one
    driver.find_element_by_xpath(
        "//button[@class='_2AkmmA _2Npkh4 _2MWPVK']").click()  # 1. Click on the "ADD TO CART button
    # driver.find_element_by_xpath("//button[@class='_2AkmmA _2Npkh4 _2kuvG8 _7UHT_c']").click()  # 2. Click on the "BUY NOW" button

    driver.find_element_by_xpath(
        "//button[@class='_2AkmmA _14O7kc mrmU5i']").click()  # "ADD TO CART" --> continue shopping button
